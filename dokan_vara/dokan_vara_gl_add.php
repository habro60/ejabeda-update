...
if (isset($_POST['subBtn'])) {
  ...
  $conn->query("UPDATE `flat_info` SET `dokan_vara_gl`='$acc_code' WHERE flat_title='$acc_head'");
  // header("refresh:2;bodri_gl_account_add.php");
  header('refresh:1;dokan_vara_setup.php');
}
//select query start

?>
<?php
$selectQuery = "select * from gl_acc_code where subsidiary_group_code='500' and `postable_acc`='N' and category_code='3'";
...
if (isset($_GET['id'])) {
  $idno = $_GET['id'];
  $selectQuery = "SELECT flat_title FROM `flat_info` WHERE `id`='$idno'";
  $selectQueryReuslt = $conn->query($selectQuery);
    ...
    <div class="col-md-12">
      ...
      <form action="" method="post">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
                <input type="text" name="full_name" class="form-control" value="<?php echo $row_member['flat_title']; ?>" readonly>
          </div>
        </div>
        <div class="form-group row">
