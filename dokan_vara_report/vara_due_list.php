...
<main class="app-content">
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i> Vara Due List</h1>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
    ...
    <?php
        ...
        <table id="submit">
            ...
            ?>
                ...
                <h4 id="billdate">
                    <h4  style="text-align:center"> <?php echo "As on Date:"; echo $enddate; ?>
                </h4> 
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if (empty($gl_acc_code)) {
                            ...
                            $sql="SELECT dokan_vara_detail.flat_no, dokan_vara_detail.fund_type_desc, dokan_vara_detail.num_of_paid, flat_info.flat_no,flat_info.flat_title, dokan_vara_detail.donner_paid_amt, DATEDIFF('$enddate', dokan_vara_detail.last_paid_date) AS due_days,dokan_vara_detail.last_paid_date, dokan_vara_detail.donner_pay_amt from dokan_vara_detail,flat_info where dokan_vara_detail.flat_no=flat_info.flat_no and allow_flag >'0' and dokan_vara_detail.last_paid_date <= '$enddate' order by flat_info.flat_no";


                        }else {

                            $sql="SELECT dokan_vara_detail.member_id, dokan_vara_detail.fund_type_desc, dokan_vara_detail.num_of_paid, flat_info.flat_no,flat_info.flat_title, dokan_vara_detail.donner_paid_amt, DATEDIFF('$enddate', dokan_vara_detail.last_paid_date) AS due_days,dokan_vara_detail.last_paid_date, dokan_vara_detail.donner_pay_amt from dokan_vara_detail,flat_info where dokan_vara_detail.flat_no=flat_info.flat_no and allow_flag >'0' and dokan_vara_detail.last_paid_date <= '$enddate' order by flat_info.flat_no";
                ...
                ?> 
                  <div id="">
                    ...
                    ?>  
                      ...
                      <td> <a id='print' title="Print Slip" class="btn btn-success" href="vara_due_slip.php?flat_no=<?php echo  $row['flat_no']; ?>&last_paid_date=<?php echo  $enddate; ?>"></i>Print Slip</a></td>
