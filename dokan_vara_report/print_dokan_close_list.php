...
<main class="app-content">
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i> Dokan Close List</h1>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <div class="col-md-12">
            ...
            ?>
                ...
                <h5 style="text-align:center" id="reportTitle">Dokan Close List</h5>
                ...
                if (!empty($officeId)) {
                    $officeId = $_POST['officeId'];
                    $sql = "SELECT flat_info.flat_no,flat_info.flat_title, dokan_vara_detail.donner_pay_amt, dokan_vara_detail.effect_date, dokan_vara_detail.allow_flag FROM flat_info, dokan_vara_detail where flat_info.flat_no=dokan_vara_detail.flat_no  and dokan_vara_detail.allow_flag= '0' order by flat_info.flat_no";
                } else {
                    $sql = "SELECT flat_info.flat_no,flat_info.flat_title, dokan_vara_detail.donner_pay_amt, dokan_vara_detail.effect_date, dokan_vara_detail.allow_flag FROM flat_info, dokan_vara_detail where flat_info.flat_no=dokan_vara_detail.flat_no  and dokan_vara_detail.allow_flag='0' order by flat_info.flat_no";
                }
                    ...
                    <table class="table table-hover table-striped" id="sampleTable">
                        ...
                        <body>
                            ...
                            while ($rows = $query->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td>" . $no++ . "</td>";
                                echo "<td>" . $rows['flat_no'] . "</td>";
                                echo "<td>" . $rows['flat_title'] . "</td>";
                                echo "<td>" . $rows['donner_pay_amt'] . "</td>";
                                echo "<td>" . $rows['effect_date'] . "</td>";
                                 ?>
                        
                            <td style="background-color:lightgray; text-align: right"><?php $tot_amt = $tot_amt + $rows['donner_pay_amt']; ?></td>
                            <?php
                        ...
                        <tr style="background-color:powderblue";>
                                ...
                                <th style="text-align:left" colspan="1"><?php echo $no - 1; ?></th>  
                                <th style="text-align:left" colspan="1"> Total Amount in TK.</th>
                                <th style="text-align:left" colspan="1"><?php echo $tot_amt; ?></th>
                            </tr>
                        </tfoot>
                        </body>
