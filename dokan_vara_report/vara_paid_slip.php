...
<main class="app-content">
    ...
    <div class="row">
       <div class="col-md-12">
            ...
            $sql= "SELECT vara_receive_detail.batch_no,vara_receive_detail.paid_date,vara_receive_detail.flat_no,vara_receive_detail.paid_upto,vara_receive_detail.paid_amount,flat_info.flat_no,flat_info.flat_title FROM `vara_receive_detail`, flat_info where  vara_receive_detail.dokan_vara_gl=flat_info.dokan_vara_gl and vara_receive_detail.flat_no=flat_info.flat_no and vara_receive_detail.flat_no='$flat_no' and vara_receive_detail.paid_upto='$last_paid_date'";
        ...
        ?>
                ...
                <div id="memberName">
                    <h5 style="text-align:center"> <?php echo "Received From:"; echo $rows['flat_no']; echo "  "; echo $rows['flat_title']; ?></h5> 
                </div>
                      ...
                      <thead class="reportHead" style="background-color: lightgray; width:100%">
                        ...
                        <tbody>
                            <?php
                               ...
                               $total_bill='0';
                               $no='1';
                               $sql= "SELECT vara_receive_detail.batch_no,vara_receive_detail.flat_no,vara_receive_detail.paid_amount,flat_info.flat_no,flat_info.flat_title,vara_receive_detail.from_date,vara_receive_detail.paid_upto,vara_receive_detail.fund_type_desc,dokan_vara_detail.donner_pay_amt, DATEDIFF( dokan_vara_detail.last_paid_date,vara_receive_detail.from_date) as due_days from vara_receive_detail, flat_info,dokan_vara_detail where vara_receive_detail.flat_no=flat_info.flat_no and dokan_vara_detail.flat_no=flat_info.flat_no and  flat_info.flat_no='$flat_no' and vara_receive_detail.paid_upto='$last_paid_date'";

                            //    TIMESTAMPDIFF(MONTH, last_paid_date, effect_date) as due_days
                                 $Query = $conn->query($sql);
                                $query = $conn->query($sql);
                               ...
                               <tr>
                                ...
                                <td style="text-align: left" width="20%"><?php echo  $row['due_days']; echo " Day(s) @ TK."; echo $row['donner_pay_amt']; ?></td>
