...
$sqlquery = "SELECT fund_member.member_id, fund_member.gl_acc_code, fund_member.mobile,tran_details.tran_date, CURRENT_DATE(),tran_details.gl_acc_code,tran_details.cr_amt_loc from fund_member, tran_details where fund_member.gl_acc_code=tran_details.gl_acc_code and fund_member.member_id='2' and tran_details.tran_date=CURRENT_DATE()";
...
$message=  "=" . $text. "/- টাকা অনুদানের জন্য শুকরিয়া।
- দারুল উলূম ঢাকা ";
