        ...
        <div class="col-md-12">
            ...
            ?>
                ...
                <div class="pull-right">
                    ...
                    <a id='PDF' title="PDF" class="btn btn-danger" href="jaurnal_pdf.php?from=<?php echo $startdate; ?>&to=<?php echo $enddate; ?>&office=<?php echo $officeId; ?>"></i>PDF</a>
                    <a title="Print" class="btn btn-danger" href="jaurnal_word.php?date=BETWEEN '<?php echo $startdate; ?>' AND '<?php echo $enddate; ?>'"></i>docx</a>
                </div>
                <!-- report view option -->
                <br><br>
                <?php
