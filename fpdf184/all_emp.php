...
class PDF extends FPDF
	{
      ...
      function FancyTable($header,$a,$b,$c,$d,$e,$f,$g,$h)
{
...
$this->Ln(5);
$this->Cell(192,6,$h[0],'LR',0,'R',$fill);
...
$pdf->Cell(188, 5,"All Employee Payrole Process Report", 0, 0, 'C');
$pdf->Ln(4);
$pdf->SetFont('Times', 'B', 12);
...
$header = array('Employee Id', 'Employee Name', 'Designation', 'Basic Salary', 'Total Allowance', 'Total Deduction ', 'Netpay');
   ...
   $pdf->FancyTable($header,$a,$b,$c,$d,$e,$f,$g,$h);
