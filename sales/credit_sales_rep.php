...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i> Credit Sale Report</h1>
        </div>
    </div>
    ...
    <div>
     ...
     <div>
        <h4 style="text-align:center">Credit Sale Report </h4>
    </div>
