              ...
              <table class="table bg-light table-bordered table-sm" id="multi_table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="text" name="exp_tot_amt_loc[]" id="exp_tot_amt_loc" data-srno="1" class="exp_tot_amt_loc form-control" /></td>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.remove_row', function() {
                ...
                var total_item_amount = $('#exp_tot_amt_loc' + row_id).val();
            ...
            function total(count) {
                ...
                for (j = 1; j <= count; j++) {
                    ...
                    if (item_qty > 0) {
                        ...
                        if (unit_price > 0) {
                            item_total = parseFloat(item_qty) * parseFloat(unit_price);
                            sub_total = parseFloat(sub_total) + parseFloat(item_total);
                            $('#exp_tot_amt_loc' + j).val(item_total.toFixed(2));
                        }
                    }
                }
