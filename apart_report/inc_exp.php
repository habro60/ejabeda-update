...
<main class="app-content">
    ...
    <div id="organizationAdd">
             ...
             <div>
                <div id="reporttitle">
                     <h6 style="text-align:center" id="reportTitle"><b>Report Type :  </b>Income and Expenditure Statement</h6> 
                </div>
                <div id="AsOnDate">
                ...
                <div id="mySelector">
                    <div class="row">
                        <div class="cols6">
                                <table style="width:420px;margin-top:20px;margin-left:100px;margin-right:40px;border-collapse: collapse;" id="sampleTable" class="table table-hover table-striped" id="sampleTable">
                                <thead class="reportHead" style="background-color: green;">
                                    ...
                                    <tr>
                                        ...
                                        <th class="bala" style="width: 4%;">Balance</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                        ...
                        <div style="width:300px;" class="cols6">
                            <div id="mySelector">
   <table style="width:420px;margin-top:20px;margin-left:50px;margin-right:60px;border-collapse: collapse;" id="sampleTable"  class="table table-hover table-striped" id="sampleTable">
                                    <thead class="reportHead" style="background-color: gray;">
                                        ...
                                        <th style="width: 2%;text-align:center;">Balance</th>
                                    </thead>
                                    <tbody>
                                        <?php
                                        if (!empty($officeId)) {
