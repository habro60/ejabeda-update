...
<main class="app-content">
    ...
    <div id="organizationAdd">
             ...
             <div>
                <div id="reporttitle">
                     <h6 style="text-align:center" id="reportTitle"><b>Report Type :  </b>GL A/C Statement</h6> 
                </div>
                <div id="AsOnDate">
                ...
                <table style="width:800px;margin-top:50px;margin-left:120px;margin-right:40px;border: 1px solid black;border-collapse: collapse;" id="sampleTable">
                    ...
                    <tbody style="">
                        ...
                        <tr style="font-weight:bold;color: red;text-align: center;">
                            ...
                            <td style="border: 1px solid black;"><?php echo $result_opbal['debit']; ?></td>
                            <td style="border: 1px solid black;"><?php echo $result_opbal['credit']; ?></td>
                        ...
                        while ($rows = $query->fetch_assoc()) {
                            if ($rows['tran_date'] >= $startdate) {
                                ...
                                <td style="text-align:center;width:10%;border: 1px solid black;border-collapse: collapse;padding:10px;">' . number_format($rows['dr_amt_loc'], 2, '.', ',') . '</td>
                                <td style="text-align:center;width:10%;border: 1px solid black;border-collapse: collapse;padding:10px;">' . number_format($rows['cr_amt_loc'], 2, '.', ',')  . '</td>
                                 <td style="text-align:center;width:10%;border: 1px solid black;border-collapse: collapse;padding:10px;"><strong>' . number_format($rows['RunningBalance'], 2, '.', ',') . '</strong></td>
                            </tr>';
                            $i++;
                            }
                            
                        } ?>
                        <tr style="font-weight:bold;border: 1px solid black;" class="text-center">
                            ...
                            <td style="border: 1px solid black;padding:10px;"> <?php echo number_format($total_dr, 2, '.', ','); ?></td>
                            <td style="border: 1px solid black;padding:10px;"><?php echo number_format($total_cr, 2, '.', ','); ?></td>
