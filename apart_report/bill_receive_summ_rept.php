                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                <?php
                                $sql1 = "SELECT tran_details.tran_date,tran_details.gl_acc_code,sum(tran_details.cr_amt_loc- tran_details.dr_amt_loc) as cr_amt,apart_bill_charge_setup.bill_charge_code,apart_bill_charge_setup.bill_charge_name,apart_bill_charge_setup.link_gl_acc_code,gl_acc_code.acc_code,gl_acc_code.category_code,gl_acc_code.rep_glcode  from apart_bill_charge_setup,tran_details,gl_acc_code where apart_bill_charge_setup.link_gl_acc_code=gl_acc_code.rep_glcode and gl_acc_code.category_code=3 and gl_acc_code.acc_code=tran_details.gl_acc_code and (tran_details.tran_date BETWEEN '$startdate' and '$enddate') group by gl_acc_code.rep_glcode";
                                ...
                                while ($row = $query1->fetch_assoc()) {
                                 ?>
                                    <tr>
                                           ...
                                           <td style="text-align: right"><?php echo $row['cr_amt'];$total_generator = ($total_generator + $row['cr_amt']);?></td>
