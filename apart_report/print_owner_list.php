...
<main class="app-content">
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i> Owner/Merchant List</h1>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        <div class="col-md-12">
            ...
            ?>
                ...
                <h5 style="text-align:center" id="reportTitle">Shop/Marchent/Owner List</h5>
                ...
                if (!empty($officeId)) {
                    $officeId = $_POST['officeId'];
                    $sql = "SELECT flat_info.flat_title, apart_owner_info.owner_name, apart_owner_info.mobile_no, flat_info.flat_no, apart_owner_info.owner_id  , apart_owner_info.gl_acc_code FROM `apart_owner_info`,flat_info, gl_acc_code where apart_owner_info.owner_id=flat_info.owner_id and apart_owner_info.gl_acc_code=gl_acc_code.acc_code order by flat_info.flat_no";
                } else {
                    $sql = "SELECT flat_info.flat_title, apart_owner_info.owner_name, apart_owner_info.mobile_no, flat_info.flat_no, apart_owner_info.owner_id  , apart_owner_info.gl_acc_code FROM `apart_owner_info`,flat_info, gl_acc_code where apart_owner_info.owner_id=flat_info.owner_id and apart_owner_info.gl_acc_code=gl_acc_code.acc_code order by flat_info.flat_no";
                }
                ...
                <div id="mySelector">
                    <table class="table table-hover table-striped" id="sampleTable">
                        <thead class="reportHead" style="background-color: green;">
                             <th>Sl.NO.</th>
                            <th>Shop/Flat No.</th>
                            <th>Shop/Flat Name</th>
                            <th>Mobile Number</th>
                            <th>Owner/Marchent ID</th>
                            <th>Owner/Marchent Name</th>
                            <th>Owner/Marchent GL Code</th>
