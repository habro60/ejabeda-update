...
<main class="app-content">
    ...
    <div id="organizationAdd">
                 ...
                 <div id="reporttitle">
                     <h6 style="text-align:center" id="reportTitle"><b>Report Type :  </b>Bill Paid Report</h6> 
                </div>
                ...
                ?>
                <div id="mySelector">
                    <table style="width:800px; margin-left:120px;border: 1px solid #808080;border-collapse: collapse;margin-top:30px; text-align:center;" id="sampleTable">
                        <thead class="reportHead" style="background-color: green;">

                                <th style="text-align:center;width:25%;border: 1px solid #808080;border-collapse: collapse;padding:5px;" >Sl.NO.</th>
                                <th style="text-align:center;width:25%;border: 1px solid #808080;border-collapse: collapse;padding:5px;">Shop/Flat Number</th>
                                <th style="text-align:center;width:25%;border: 1px solid #808080;border-collapse: collapse;padding:5px;">Shop/Owner Name</th>
                                <th style="text-align:center;width:25%;border: 1px solid #808080;border-collapse: collapse;padding:5px;">Bill Received Date</th>
                                <th style="text-align:center;width:25%;border: 1px solid #808080;border-collapse: collapse;padding:5px;">Voucher No</th>
                                <th style="text-align:center;width:25%;border: 1px solid #808080;border-collapse: collapse;padding:5px;">Bill for Month</th>
                                <th style="text-align:center;width:25%;border: 1px solid #808080;border-collapse: collapse;padding:5px;">Service Name</th>
                                <th style="text-align:center;width:25%;border: 1px solid #808080;border-collapse: collapse;padding:5px;">Bill amount</th>
                                <th style="text-align:center;width:25%;border: 1px solid #808080;border-collapse: collapse;padding:5px;">Bill Paid Amount</th>
                        ...
                        <body>
                            ...
                            ?>
                              ...
                              <td style="text-align:center;width:5%;border: 1px solid #808080;border-collapse: collapse;padding:5px;"><?php if ($rows['batch_no'] != $batch_no) {
                                ...
                                <td style="text-align:center;width:5%;border: 1px solid #808080;border-collapse: collapse;padding:5px;"><?php  echo number_format($rows['bill_amount'], 2, '.', ',') ; ?></td>
                                
                                
                                
                                <td style="text-align:center;width:5%;border: 1px solid #808080;border-collapse: collapse;padding:5px;"><?php echo number_format($rows['bill_amount'], 2, '.', ','); 
                      ...
                      <tfoot>
                        <tr style="background-color:powderblue; margin-top: -20px;">
                                <th style="text-align:center;width:25%;border: 1px solid #808080;border-collapse: collapse;padding:5px;" colspan="7"> Total Amount in TK.</th>
                                <th style="text-align:center;width:25%;border: 1px solid #808080;border-collapse: collapse;padding:5px;" colspan="1"><?php echo number_format($tot_dr_amt, 2, '.', ',') ; ?></th>
                                <th style="text-align:center;width:25%;border: 1px solid #808080;border-collapse: collapse;padding:5px;" colspan="1"><?php $val=($tot_dr_amt - $tot_cr_amt); 
