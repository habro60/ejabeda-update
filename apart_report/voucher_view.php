...
<main class="app-content">
    ...
    <div>
        <h6 style="text-align:center"> <b>Report Type :  </b>Voucher </h6>
        <?php
                ...
                <div class="col-md-12">
                    ...
                    <div class="maingl">
                        <div class="leftgl" style="margin-left:77px;margin-bottom:40px;">
                            ...
                            <p><strong>Voucher Type :</strong> <?php echo $row['tran_mode']; ?></p>
                        ...
                        <tbody style="border="4"">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style='text-align:center'> <?php $val=number_format($rows['dr_amt_loc'], 2, '.', ',');
                                    echo $val; ?></td>
                                    <td style='text-align:center'> <?php $val2=number_format($rows['cr_amt_loc'], 2, '.', ','); echo $val2; ?></td>
                                </tr>
                        <?php
                        $i++;
                            }
