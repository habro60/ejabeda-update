                ...
                if ($flat_no != $rows['flat_no'] && $flag !='0') {  
                   echo     
                    '<tr>
                        ...
                        <td style="text-align:right;font-weight:bold; width:20%" <strong> Total Bill Amount : ' . $sub_tot_bill_amt . ' <strong></td> 
                    </tr>';
                    ?>
            <tr>
                <td>                              
            ...
            if ($flat_no != $rows['flat_no']) {
                ...
                $flag='1';
                    ...
                    '<tr style="text-align:left; " >
                        ...
                        <td style="text-align:100px"                     Curr.Unit=' . $rows['curr_unit'] .  ' Prev.Unit=' . $rows['prev_unit'] . ' Net Unit=' . $rows['net_unit'] . ' 
