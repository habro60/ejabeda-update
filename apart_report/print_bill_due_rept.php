...
<main class="app-content">
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i> Bill Due Report</h1>
        </div>
    ...
    <div class="row">
        ...
        ?>
            ...
            <div id="reporttitle">
                <h6 style="text-align:center" id="reportTitle"><b></b>Bill Due Report</h6>
            </div>
            ...
            if (isset($_POST['submit'])) {
                ...
                if (empty($gl_acc_code)) {
                    $sql = "SELECT apart_owner_bill_detail.owner_id, apart_owner_bill_detail.bill_charge_code,apart_owner_bill_detail.bill_charge_name,date_format(apart_owner_bill_detail.bill_date, '%M %Y') as month,apart_owner_bill_detail.bill_amount, apart_owner_bill_detail.flat_no,apart_owner_bill_detail.owner_gl_code, apart_owner_bill_detail.bill_paid_flag,apart_owner_bill_detail.bill_for_month, tran_details.tran_date, tran_details.gl_acc_code,tran_details.dr_amt_loc,tran_details.batch_no, apart_owner_info.owner_id,apart_owner_info.owner_name from apart_owner_bill_detail, tran_details, apart_owner_info where tran_details.vaucher_type='DR' and tran_details.gl_acc_code=apart_owner_bill_detail.owner_gl_code and apart_owner_info.owner_id=apart_owner_bill_detail.owner_id and tran_details.tran_date=apart_owner_bill_detail.bill_process_date and apart_owner_bill_detail.batch_no=tran_details.batch_no and apart_owner_bill_detail.bill_paid_flag='0' AND (tran_details.tran_date BETWEEN '$startdate' AND '$enddate') and apart_owner_bill_detail.bill_amount > '0' order by  apart_owner_bill_detail.flat_no,apart_owner_bill_detail.bill_for_month,apart_owner_bill_detail.bill_charge_code";
                } else {

                    $sql = "SELECT tran_details.batch_no,tran_details.tran_date, date_format(apart_owner_bill_detail.bill_date, '%M %Y') as month, tran_details.gl_acc_code, tran_details.dr_amt_loc,tran_details.cr_amt_loc, apart_owner_bill_detail.owner_gl_code, apart_owner_bill_detail.owner_id, apart_owner_bill_detail.bill_paid_flag, apart_owner_bill_detail.bill_charge_code, apart_owner_bill_detail.bill_charge_name, apart_owner_bill_detail.bill_amount,apart_owner_bill_detail.flat_no,apart_owner_bill_detail.bill_for_month, apart_owner_info.gl_acc_code, apart_owner_info.owner_name from apart_owner_bill_detail, tran_details,apart_owner_info where tran_details.gl_acc_code=apart_owner_bill_detail.owner_gl_code and apart_owner_bill_detail.owner_gl_code='$gl_acc_code'and  tran_details.vaucher_type='DR' and apart_owner_info.gl_acc_code=tran_details.gl_acc_code and tran_details.tran_date=apart_owner_bill_detail.bill_process_date and apart_owner_bill_detail.batch_no=tran_details.batch_no and apart_owner_bill_detail.bill_paid_flag=0  AND (tran_details.tran_date BETWEEN '$startdate' AND '$enddate') and apart_owner_bill_detail.bill_amount > '0' order by apart_owner_bill_detail.flat_no,apart_owner_bill_detail.bill_for_month,apart_owner_bill_detail.bill_charge_code";
                }
                // echo $sql;
                // die;
            ...
            ?>
                <div id="mySelector">
                    <table style="margin:20px;border: 1px solid #808080;border-collapse: collapse;margin-top:0px; text-align:center;" id="sampleTable">
                        <thead class="reportHead" style="background-color: green;">
                            <th style="text-align:center; width:5%; border-collapse: collapse;  border: 1px solid #808080;">Sl.NO.</th>
                            <th style="text-align:center; width:10%; border-collapse: collapse; border: 1px solid #808080;">Shop/Flat No.</th>
                            <th style="text-align:center; width:20%; border-collapse: collapse; border: 1px solid #808080;">Shop/Owner Name</th>
                            <th style="text-align:center; width:10%; border-collapse: collapse; border: 1px solid #808080;">Voucher No</th>
                            <th style="text-align:center; width:15%; border-collapse: collapse; border: 1px solid #808080;">Bill Issue Date</th>
                            <th style="text-align:center; width:15%; border-collapse: collapse; border: 1px solid #808080;">Bill for Month</th>
                            <th style="text-align:center; width:30%; border-collapse: collapse; border: 1px solid #808080;">Service Name</th>
                            <th style="text-align:center; width:25%; border-collapse: collapse; border: 1px solid #808080; padding:10px;">Bill Amount </th>
                            <th style="text-align:center; width:25%; border-collapse: collapse; border: 1px solid #808080; padding:10px;">Bill Due Amount</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td style="text-align: center;border: 1px solid #808080;"><?php if ($rows['owner_id'] != $owner_id) {
                                                                                                echo $no++;
                                                                                            } else {
                                                                                                echo "";
                                                                                            } ?></td>
                                    ...
                                    <td style="text-align: center;border: 1px solid #808080;"><?php echo $rows['batch_no'];
                                                                                            ?></td>
                                    <td style="text-align: center;border: 1px solid #808080;"><?php echo date('d-m-Y ', strtotime($rows['tran_date']));
                                                                                            ?></td>
                                    <td style="text-align: center;border: 1px solid #808080;"><?php echo
                                                                                            date('M Y ', strtotime($rows['bill_for_month']));
                                                                                            ?></td>

                                    <td style="background-color:powderblue; text-align: left;border: 1px solid #808080;"><?php if ($rows['bill_paid_flag'] == '0') {
                                    ...
                                    <td style="background-color:powderblue; text-align: right;border: 1px solid #808080;"><?php echo number_format($rows['bill_amount'], 2, '.', ','); ?></td>



                                    <td style="text-align: right;border: 1px solid #808080;"><?php echo number_format($rows['bill_amount'], 2, '.', ',');
