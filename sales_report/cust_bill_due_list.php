...
if (empty($supp_id)) {
    ...
    $sql2 =  "SELECT  cust_info.id, cust_info.cust_name, cust_info.gl_acc_code, sales_detail.gl_acc_code FROM  cust_info, sales_detail where cust_info.gl_acc_code = $supp_id ORDER BY cust_info.gl_acc_code, sales_detail.order_date";
}
...
<main class="app-content">
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i>Customer Bill Due Report</h1>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
    ...
    <?php
        ...
        <table id="submit">
            ...
            ?>
                ...
                <h4 style="text-align:center" id="reportTitle">Customer Bill Due Report</h4>
                ...
                <div id="mySelector">
                    ...
                    <th>Due amount</th>
                     ...
                     <td style="text-align: right"><?php if ($rows['batch_no'] != $batch_no) {
                        ...
                        $tot_sales_amt = $tot_sales_amt + $rows['dr_amt_loc'];
                    ...
                    <td style="text-align: right"><?php if ($rows['batch_no'] != $batch_no) {
                        ...
                        <td style="text-align: right"><?php if ($rows['batch_no'] != $batch_no) {
                                 echo ($rows['dr_amt_loc']-$rows['cr_amt_loc']); 
                        $tot_due_amt = $tot_due_amt + ($rows['dr_amt_loc']-$rows['cr_amt_loc']);
                      ...
                      <tfoot>
                        <tr style="background-color:powderblue";>
                                ...
                                <th style="text-align:right" colspan="1"><?php echo $tot_sales_amt; ?></th>
