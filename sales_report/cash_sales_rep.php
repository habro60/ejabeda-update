...
if (empty($cust_id)) {
    $sql2 = "SELECT  cust_info.id, cust_info.supp_name, cust_info.gl_acc_code, sales_detail.gl_acc_code FROM  cust_info, sales_detail where cust_info.gl_acc_code = sales_detail.gl_acc_code ORDER BY cust_info.gl_acc_code, sales_detail.order_date";
} else {
    $sql2 =  "SELECT  cust_info.id, cust_info.supp_name, cust_info.gl_acc_code, sales_detail.gl_acc_code FROM  cust_info, sales_detail where cust_info.gl_acc_code = $cust_id ORDER BY cust_info.gl_acc_code, sales_detail.order_date";
}
...
<main class="app-content">
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i>Cash & Cheque Sales Report</h1>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
    ...
    <?php
        ...
        <table id="submit">
            ...
            ?>
                ...
                <h4 style="text-align:center" id="reportTitle">Cash/CHQ. Sales</h4>
                ...
                <div id="mySelector">
                    ...
                    <th>Sales amount</th>
                     ...
                     <td style="text-align: right"><?php if ($rows['batch_no'] != $batch_no) {
                        ...
                        $tot_sale_amt = $tot_sale_amt + $rows['dr_amt_loc'];
                      ...
                      <tfoot>
                        <tr style="background-color:powderblue";>
                                ...
                                <th style="text-align:right" colspan="1"><?php echo $tot_sale_amt; ?></th>
