            ...
            ?>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if (empty($gl_acc_code)) {
                            ...
                            $sql="SELECT  fund_receive_detail.member_id, fund_receive_detail.paid_date, fund_receive_detail.paid_upto,donner_fund_detail.member_id,donner_fund_detail.donner_pay_amt,donner_fund_detail.last_paid_date, fund_member.member_no,fund_member.full_name FROM `donner_fund_detail`,fund_member,fund_receive_detail WHERE fund_member.gl_acc_code=donner_fund_detail.gl_acc_code and fund_receive_detail.member_id=donner_fund_detail.member_id and donner_fund_detail.last_paid_date <='$last_paid_date' group by fund_receive_detail.member_id order by fund_member.member_no";

                           

                        }else {

                            $sql="SELECT donner_fund_detail.member_id,donner_fund_detail.donner_pay_amt,donner_fund_detail.last_paid_date, fund_member.member_no,fund_member.full_name FROM `donner_fund_detail`,fund_member WHERE fund_member.gl_acc_code=donner_fund_detail.gl_acc_code and donner_fund_detail.last_paid_date ='$last_paid_date' order by fund_member.member_no";
                ...
                ?> 
                  <div id="">
                    ...
                    ?>  
                      ...
                      <td> <a id='print' title="Print Slip" class="btn btn-success" href="chanda_paid_slip.php?member_id=<?php echo  $row['member_id']; ?>&last_paid_date=<?php echo  $row['last_paid_date']; ?>"></i>Print Slip</a></td>
