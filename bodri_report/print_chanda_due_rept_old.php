            ...
            ?>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if (empty($member_id)) {
                            ...
                            - YEAR(last_paid_date)) 
                     + (MONTH('$enddate') 
                         - MONTH(last_paid_date)))  as due_month, donner_fund_detail.donner_pay_amt from donner_fund_detail,fund_member where donner_fund_detail.member_id=fund_member.member_id and allow_flag >'0' and donner_fund_detail.last_paid_date <= '$enddate' order by fund_member.member_no"; 
                            ...
                            - YEAR(last_paid_date)) 
                     + (MONTH('$enddate') 
                         - MONTH(last_paid_date)))  as due_month, donner_fund_detail.donner_pay_amt from donner_fund_detail,fund_member where donner_fund_detail.member_id=fund_member.member_id and allow_flag >'0' and donner_fund_detail.member_id='$member_id' and donner_fund_detail.last_paid_date <= '$enddate' order by fund_member.member_no";
