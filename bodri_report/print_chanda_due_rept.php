                    ...
                    if (empty($member_id)) {
                     ...
                     + (MONTH('$enddate') 
                         - MONTH(last_paid_date)))  as due_month, sum(mthly_rate_setup.rate_amt) as pay_amt from donner_fund_detail,fund_member, mthly_rate_setup where (mthly_rate_setup.rate_date > donner_fund_detail.last_paid_date and mthly_rate_setup.rate_date  <= '$enddate') and donner_fund_detail.member_id=fund_member.member_id and allow_flag >'0' and donner_fund_detail.last_paid_date <= '$enddate' group by fund_member.member_no order by fund_member.member_no"; 
                            ...
                            $sql="SELECT donner_fund_detail.member_id, donner_fund_detail.fund_type_desc, donner_fund_detail.num_of_paid, fund_member.member_no, fund_member.full_name, donner_fund_detail.donner_paid_amt, (12 * (YEAR('2022-1-17') 
                            - YEAR(last_paid_date)) 
                     + (MONTH('2022-1-17') 
                         - MONTH(last_paid_date)))  as due_month, sum(mthly_rate_setup.rate_amt) as pay_amt from donner_fund_detail,fund_member, mthly_rate_setup where (mthly_rate_setup.rate_date > donner_fund_detail.last_paid_date and mthly_rate_setup.rate_date  <= '2022-1-17') and donner_fund_detail.member_id=fund_member.member_id and allow_flag >'0' and donner_fund_detail.last_paid_date <= '2022-1-17' AND donner_fund_detail.member_id=$member_id group by fund_member.member_no order by fund_member.member_no";
