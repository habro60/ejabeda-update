...
if (isset($_POST["submit"])) {
    ...
    for ($count = 0; $count < count($_POST["particular"]); $count++) {
            ...
            $by_account = $_POST['to_account'][$count];
            $vaucher_type = "DR";
            $dr_tran_amt= $_POST['tran_amt'][$count];
            $cr_tran_amt= '0';
            $tran_mode = $tran_mode='CASP';;  
        ...
        echo "<meta http-equiv=\"refresh\" content=\"0;URL=personal_cash_expense.php\">";
}
...
<main class="app-content">
    <form action="" method="post">
        <table class="table bg-light table-bordered table-sm">
            <thead>
                <td>
                    <th>Debit Voucher from Cash A/C</th>
