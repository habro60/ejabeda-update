        ...
        <div class="col-md-12">
                            ...
                            <tr>
                                <td>
                                    <select class="select2 form-control" name="account" id="account"  style="width: 150px;" >
                                        ...
                                        $selectQuery = "SELECT * FROM `personal_account` where `owner_rec_id`=$owner_rec_id  ORDER by id";
            ...
            <div>
                ...
                ?>
                    ...
                    <?php 
                       $sql="SELECT apart_owner_info.owner_name,apart_owner_info.mobile_no from apart_owner_info where apart_owner_info.id='$owner_rec_id'";
            ...
            <div id="mySelector">
                <table class="table table-hover table-striped" id="sampleTable">
                    ...
                    <tbody>
                        ...
                        $sql="SELECT personal_account.id,personal_account.acc_head, personal_account.category_code from personal_account where personal_account.owner_rec_id='$owner_rec_id' and personal_account.id='$account'";
                            $query2 = mysqli_query($conn, $sql);
                            $ownerRows = mysqli_fetch_assoc($query2);
                        ...
                        <tr style="font-weight:bold;color: red;text-align: right">
                            ...
                            <td>
                                ...
                                <?php if ($category_code !='3') {echo $result_opbal['debit'] - $result_opbal['credit'];} else {echo $result_opbal['credit'] - $result_opbal['debit']; } ?>
                            </td>
                        </tr>
                        <?php
                        $total_dr = 0;
                    ...
                    $category_code= $ownerRows['category_code'];
                    if ($category_code ='3') {
                        $sql="SELECT personal_ledger.tran_no,personal_ledger.gl_acc_code,personal_ledger.tran_mode,personal_ledger.dr_amt_loc,personal_ledger.tran_date,personal_ledger.tran_mode,personal_ledger.description,personal_ledger.cr_amt_loc,personal_account.acc_head,personal_account.id,personal_ledger.cr_amt_loc-personal_ledger.dr_amt_loc as balance, @RunningBalance:= @RunningBalance + (personal_ledger.cr_amt_loc-personal_ledger.dr_amt_loc) as RunningBalance, personal_account.category_code  FROM personal_ledger JOIN personal_account JOIN (SELECT @RunningBalance:= 0) r WHERE personal_ledger.gl_acc_code='$account' AND personal_ledger.owner_rec_id='$owner_rec_id' AND personal_ledger.gl_acc_code=personal_account.id AND personal_account.category_code ='3' and (personal_ledger.tran_date BETWEEN '$org_fin_year_st' AND '$enddate') and  personal_account.owner_rec_id = '$owner_rec_id'group by personal_ledger.tran_no  order by personal_ledger.tran_date, personal_ledger.tran_no";
                    } 
                    $category_code= $ownerRows['category_code'];
                    if ($category_code !='3') {
                         $sql="SELECT personal_ledger.tran_no,personal_ledger.gl_acc_code,personal_ledger.tran_mode,personal_ledger.dr_amt_loc,personal_ledger.tran_date,personal_ledger.tran_mode,personal_ledger.description,personal_ledger.cr_amt_loc,personal_account.acc_head,personal_account.id,personal_ledger.dr_amt_loc-personal_ledger.cr_amt_loc as balance, @RunningBalance:= @RunningBalance + (personal_ledger.dr_amt_loc-personal_ledger.cr_amt_loc) as RunningBalance, personal_account.category_code  FROM personal_ledger JOIN personal_account JOIN (SELECT @RunningBalance:= 0) r WHERE personal_ledger.gl_acc_code='$account' AND personal_ledger.owner_rec_id='$owner_rec_id' AND personal_ledger.gl_acc_code=personal_account.id AND (personal_ledger.tran_date BETWEEN '$org_fin_year_st' AND '$enddate') group by personal_ledger.tran_no  order by personal_ledger.tran_date, personal_ledger.tran_no";            
                        }
                        ...
                        <tr style="font-weight:bold" class="text-right">
                            ...
                            <td>
                                ...
                                <?php if ($ownerRows['category_code'] =='3') 
