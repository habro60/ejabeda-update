...
<main class="app-content">
  ...
  <!-- <div class="row">
    <div class="col-4-sm">
      <div class="col-2-sm">
        <img src="../dashboard_image/asset_final.png" alt="asset" width="60px" height="60px"></div>
      <div class="col-2-sm">
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-lg-3">
      <div class="widget-small danger coloured-icon"><img src="../dashboard_image/Liablity.png" alt="asset" width="60px" height="60px">
        <div class="info">
          ...
          <p><b><?php echo $symbol['org_loc_curr_symbol']; ?><?php echo " "; ?> <?php echo ($liability['balance'] + $Fund['balance']); ?></b></p>
        </div>
      </div>
    </div>
    <div class="col-md-6 col-lg-3">
	...
	<?php	if ($_SESSION['org_no'] == '5000000000') { ?>
	<!--########################################## -->
	<!--########################################## -->
    <div class="col-md-6 col-lg-3">
      <div class="widget-small warning coloured-icon"><img src="../dashboard_image/gross_profit.png" alt="asset" width="60px" height="60px">
        <div class="info">
          <h4 style="color:blue;font-weight:bold"><a href="../my_form/form_new/index.php" target="_blank">Dynamic Form</a></h4>
          <p><a href="../my_form/form_new/index.php" target="_blank"><span class="glyphicon glyphicon-th"><span> Open</a></p>
        </div>
      </div>
    </div>
    <div class="col-md-6 col-lg-3">
      <div class="widget-small warning coloured-icon"><img src="../dashboard_image/gross_profit.png" alt="asset" width="60px" height="60px">
        <div class="info">
          <h4 style="color:blue;font-weight:bold"><a href="../my_report/index.php" target="_blank">Dynamic Report</a></h4>
          <p><a href="../my_report/index.php" target="_blank"><span class="glyphicon glyphicon-dashboard"><span> Open</a></p>
        </div>
      </div>
    </div>
	<!--########################################## -->
