...
<main class="app-content">
  ...
  <div class="row">
    <div class="col-md-6 col-lg-3">
      <div class="widget-small info coloured-icon"> <img src="../dashboard_image/asset _final.png" alt="asset" width="60px" height="60px"> 
        <div class="info">
    ...
    <div class="col-md-6 col-lg-3">
      <div class="widget-small danger coloured-icon"><img src="../dashboard_image/Liablity.png" alt="asset" width="60px" height="60px"> 
        <div class="info">
          ...
          <p><b><?php echo $symbol['org_loc_curr_symbol']; ?><?php echo ($liability['balance'] + $Fund['balance']); ?></b></p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6 col-lg-3">
      <div class="widget-small warning coloured-icon"><img src="../dashboard_image/Sale.png" alt="asset" width="60px" height="60px"> 
        <div class="info">
          ...
          <p><b><?php echo $symbol['org_loc_curr_symbol']; ?><?php echo $sales['total_sales']; ?></b></p>
        </div>
      </div>
    </div>
    <div class="col-md-6 col-lg-3">
    ...
    <div class="col-md-6 col-lg-3">
      <div class="widget-small warning coloured-icon"><img src="../dashboard_image/Expense.png" alt="asset" width="60px" height="60px"> 
        <div class="info">
          ...
          <p><b><?php echo $symbol['org_loc_curr_symbol']; ?><?php echo $expense['balance']; ?></b></p>
        </div>
      </div>
    </div>
    <div class="col-md-6 col-lg-3">
      <div class="widget-small warning coloured-icon"><img src="../dashboard_image/income_final.png" alt="asset" width="60px" height="60px"> 
        <div class="info">
          ...
          <p><b><?php echo $symbol['org_loc_curr_symbol']; ?><?php echo $income['balance']; ?></b></p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-6 col-lg-3">
      <div class="widget-small warning coloured-icon"><img src="../dashboard_image/Purchase.png" alt="asset" width="50px" height="60px"> 
        <div class="info">
          ...
          <p><b><?php echo $symbol['org_loc_curr_symbol']; ?><?php echo $purchase['total_purchase']; ?></b></p></div>
      </div>
    </div>
