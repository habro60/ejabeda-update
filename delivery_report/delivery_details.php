...
<main class="app-content">
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i>Delivery Details Report</h1>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
    ...
    <?php
        ...
        <table id="submit">
            ...
            ?>
                ...
                <h4 style="text-align:center" id="reportTitle">Delivery Details</h4>
                ...
                <div id="mySelector">
                    ...
                    <th>Delivery amount</th>
                     ...
                     <td style="background-color:powderblue;width:300px ;text-align: left"><?php echo $rows['total_price_loc'];?></td>
