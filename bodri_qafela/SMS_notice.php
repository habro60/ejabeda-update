...
$sqlquery = "SELECT fund_member.member_id, fund_member.member_no,fund_member.gl_acc_code, fund_member.mobile from fund_member";
...
// die;
    ...
    echo "<meta http-equiv=\"refresh\" content=\"0;URL=notice_to_all_member.php\">";
