                   ...
                   <table class="form_class_id" id="submit">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>Up to Date: <input type="date" name="enddate" id="" class="form-control" required></td>
            ...
            ?>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $gl_acc_code =$result['acc_code'];
                            ...
                            $sql="SELECT  donner_fund_detail.fund_type, donner_fund_detail.member_id,donner_fund_detail.fund_type_desc,donner_fund_detail.num_of_pay,donner_fund_detail.donner_pay_amt,donner_fund_detail.num_of_paid,donner_fund_detail.donner_paid_amt,donner_fund_detail.due_amt,donner_fund_detail.waiver_amt, fund_member.member_id,fund_member.gl_acc_code, fund_member.full_name FROM  `donner_fund_detail`,fund_member where fund_member.member_id = donner_fund_detail.member_id and fund_member.gl_acc_code='$gl_acc_code' and donner_fund_detail.effect_date  <= '$enddate' and donner_fund_detail.donner_pay_amt > '0' order by donner_fund_detail.member_id, donner_fund_detail.fund_type";
