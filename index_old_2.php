...
if ($_POST['org_no'] == '1000000000') { 
   $conn = new mysqli("localhost","root","","ejabeda_green_daru_apart");
	...
	$connect = new PDO('mysql:host=localhost; dbname=ejabeda_green_daru_apart;', 'root', '');
	$connect->exec("set names utf8");
  }   
  elseif ($_POST['org_no'] == '1100000000') {
    $conn = new mysqli("localhost","root","","ejabeda_bismillah");
	$conn->set_charset("utf8");
	$connect = new PDO('mysql:host=localhost; dbname=ejabeda_bismillah;', 'root', '');
	$connect->exec("set names utf8");
  }
  elseif ($_POST['org_no'] == '1200000000') {
    $conn = new mysqli("localhost","root","","ejabeda_kah_high_school");
	$conn->set_charset("utf8");
	$connect = new PDO('mysql:host=localhost; dbname=ejabeda_kah_high_school;', 'root', '');
	$connect->exec("set names utf8");
  }
  elseif ($_POST['org_no'] == '1300000000') {
    $conn = new mysqli("localhost","root","","ejabeda_sheltech");
	$conn->set_charset("utf8");
	$connect = new PDO('mysql:host=localhost; dbname=ejabeda_sheltech;', 'root', '');
	$connect->exec("set names utf8");
  }
  ...
  elseif ($_POST['org_no'] == '1700000000') {
    $conn = new mysqli("localhost","root","","ejabeda_landmark_Apt");
	$conn->set_charset("utf8");
	$connect = new PDO('mysql:host=localhost; dbname=ejabeda_landmark_Apt;', 'root', '');
	$connect->exec("set names utf8");
  }
  elseif ($_POST['org_no'] == '1400000000') {
    $conn = new mysqli("localhost","root","","ejabeda_pastry_ghar");
	$conn->set_charset("utf8");
	$connect = new PDO('mysql:host=localhost; dbname=ejabeda_pastry_ghar;', 'root', '');
	$connect->exec("set names utf8");
  }
  ...
  elseif ($_POST['org_no'] == '2000000000') {
    $conn = new mysqli("localhost","root","","ejabeda_daruluo_dhaka");
	$conn->set_charset("utf8");
	$connect = new PDO('mysql:host=localhost; dbname=ejabeda_daruluo_dhaka;', 'root', '');
	$connect->exec("set names utf8");
  }
  elseif ($_POST['org_no'] == '2100000000') {
    $conn = new mysqli("localhost","root","","ejabeda_karna_ind");
	$conn->set_charset("utf8");
	$connect = new PDO('mysql:host=localhost; dbname=ejabeda_karna_ind;', 'root', '');
	$connect->exec("set names utf8");
  }
  elseif ($_POST['org_no'] == '2400000000') {
    $conn = new mysqli("localhost","root","","ejabeda_dapunia");
	$conn->set_charset("utf8");
	$connect = new PDO('mysql:host=localhost; dbname=ejabeda_dapunia;', 'root', '');
	$connect->exec("set names utf8");
  }
  ...
  if ($rowcount > 0) {
    while ($row = $result->fetch_assoc()) {
      if ($row['user_status'] == 1) {
        ...
        $org_allow_online_tran = $row['org_allow_online_tran'];
        $org_allow_langu_type = $row['org_allow_langu_type'];
        ...
        if (password_verify($password, $row["password"])) {
          ...
          $_SESSION['org_allow_online_tran'] = $org_allow_online_tran;
          $_SESSION['org_allow_langu_type'] = $org_allow_langu_type;
