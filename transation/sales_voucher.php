...
if (isset($_POST["submit"])) {
    ...
    for ($count = 0; $count < count($_POST["item_no"]); $count++) {
        ...
        $query = "INSERT INTO invoice_detail (office_code,order_type,in_out_flag, order_no, gl_acc_code, order_date, item_no, item_qty, item_unit, unit_price_loc,total_price_loc,bill_status, item_status,status_date, ss_creator,ss_created_on,ss_org_no) VALUES (:office_code,:order_type,:in_out_flag,:batch_no,:gl_acc_code,:tran_date,:item_no,:item_qty,:item_unit, :unit_price_loc,:total_price_loc,:bill_status,:item_status,:status_date,:ss_creator,now(),:ss_org_no)";
        // echo $query; exit;
        ...
        <table class="table bg-light table-bordered table-sm">
            ...
            <tbody>
                <tr>
                    ...
                    <td> <input type="text" id="date" class="org_form" id="clock" value="<?php date_default_timezone_set('Asia/Dhaka'); echo date("h:i:sa"); ?>" readonly></td>
                </tr>
            </tbody>
        </table>
