...
if (isset($_POST['subBtn'])) {
    ...
    //-------------------
    // dr
    $insertQuerydr="INSERT INTO `tran_details` (`tran_no`, `auto_tran_no`, `office_code`, `year_code`, `batch_no`, `tran_date`, `back_value_date`, `gl_acc_code`, `tran_mode`, `vaucher_type`, `dr_amt_loc`, `cr_amt_loc`, `dr_amt_fc`, `cr_amt_fc`, `bank_name`, `branch_name`, `cheque_no`, `cheque_date`, `curr_code`, `exch_rate`, `description`, `reversaled`, `rev_tran_no`, `auto_tran`, `posted`, `verified_by_1`, `verified_date_1`, `pay_on_vouch_no`, `purchase_date`, `bill_paid_flag`, `ss_creator`, `ss_creator_on`, `ss_modified`, `ss_modified_on`, `ss_org_no`) VALUES (NULL, '0','$office_code','$year_code','$batch_no','$tran_date', '$tran_date', '$by_account', '$tran_mode', '$vaucher_typedr', '$craccount', '0', '0', '0', 'N/A', 'N/A', 'N/A', '2022-05-17', '01', '0.0000', '$particular', '0', '0', '0', '1', '$ss_creator', now(), '0', '2022-05-17 14:09:48', '0', '$ss_creator', now(), 'N/A', '9999-09-09', '$ss_org_no')";
    // echo $insertQuerydr;
    // exit;
    ...
    // cr
    $insertQuerycr="INSERT INTO `tran_details` (`tran_no`, `auto_tran_no`, `office_code`, `year_code`, `batch_no`, `tran_date`, `back_value_date`, `gl_acc_code`, `tran_mode`, `vaucher_type`, `dr_amt_loc`, `cr_amt_loc`, `dr_amt_fc`, `cr_amt_fc`, `bank_name`, `branch_name`, `cheque_no`, `cheque_date`, `curr_code`, `exch_rate`, `description`, `reversaled`, `rev_tran_no`, `auto_tran`, `posted`, `verified_by_1`, `verified_date_1`, `pay_on_vouch_no`, `purchase_date`, `bill_paid_flag`, `ss_creator`, `ss_creator_on`, `ss_modified`, `ss_modified_on`, `ss_org_no`) VALUES (NULL, '0','$office_code','$year_code','$batch_no','$tran_date', '$tran_date', '$toaccount', '$tran_mode', '$vaucher_typecr', '0', '$craccount', '0', '0', 'N/A', 'N/A', 'N/A', '2022-05-17', '01', '0.0000', '$particular', '0', '0', '0', '1', '$ss_creator', now(), '0', '2022-05-17 14:09:48', '0', '$ss_creator', now(), 'N/A', '9999-09-09', '$ss_org_no')";
                ...
                <tr>
                    <td style="width: 200px">
                        <select class="form-control select2" name="toaccount" id="byAccount" onchange="calculateByAccount()" required>
                            <option value="">---To Receive A/C---</option>
                            <?php
