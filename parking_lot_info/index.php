  ...
  <main class="app-content">
        <div class="card">
            <div class="card-header">
                ...
                <h3 class="card-title">Parking Lots Info</h3>
            ...
            <div class="card-body">
                <table class="table table-hover table-bordered table-sm" id="studentTable" class="display" style="width:100%">
                    ...
                    <?php
                        ...
                        $query4 = "SELECT parking_lots_info.id as pid,parking_lots_info.park_lot_no,parking_lots_info.lot_type, parking_lots_info.car_reg_no,flat_info.id,flat_info.flat_no
                        FROM parking_lots_info
                        INNER JOIN flat_info ON parking_lots_info.flat_no=flat_info.id;";
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $row['park_lot_no'] ?>
                            </td>
                            <td>
                                <?php echo $row['lot_type'] ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="#edit<?= $row['pid'] ?>" class="btn btn-outline-info btn-sm"
                                data-toggle="modal"><i
                                        class="far fa-edit"></i></a>
                                <a href="delete.php?carParkingInfoDelete=<?= base64_encode($row['pid']) ?>"
