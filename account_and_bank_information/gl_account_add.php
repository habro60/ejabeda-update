...
if (isset($_POST['subBtn'])) {
  ...
  $insertQuery = "INSERT INTO `gl_acc_code` (`id`,`office_code`, `acc_code`, `acc_head`, `postable_acc`,`address`,`vat_no`,`tin_no`,`taxable_flag`,`buyer_saler_flag`,`rep_glcode`,`is_ho_acc`,`category_code`,`acc_level`,`acc_type`,`parent_acc_code`,`is_root`,`exch_rate`,`subsidiary_group_code`,`ss_creator`,`ss_creator_on`,`ss_modifier_on`,`ss_org_no`) VALUES (NULL,'$office_code','$acc_code','$acc_head','$postable_acc','$address','$vat_no','$tin_no','$taxable_flag','$buyer_saler_flag','$rep_glcode','Y','$category_code','$acc_level','$acc_type','$parent_acc_code','1','0','$subsidiary_group_code','$ss_creator',now(),now(),'$ss_org_no')";
    ...
    <div class="col-md-12">
      ...
      <form action="" method="post">
        ...
        <div class="form-group row">
         ...
         <!-- Subsidiary A/C group  -->
         <div class="form-group row">
          <label class="col-sm-2 col-form-label">Subsidiary A/C Group</label>
          <div class="col-sm-6">
