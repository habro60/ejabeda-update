        ...
        ?>
            <tr>
                ...
                <td hidden style="text-align: center">
                    <button type="button" onclick="returnPost('<?php echo $rows['bill_charge_name']; ?>','<?php echo $rows['bill_amount']; ?>','<?php echo $no; ?>')" id="bill_paid_flag<?php echo round($no); ?>" class="btn btn-info returnPostBtn"> POST </button>
