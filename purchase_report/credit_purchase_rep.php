...
<main class="app-content">
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i>Credit Purchase Report</h1>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
    ...
    <?php
        ...
        <table id="submit">
            ...
            ?>
                ...
                <h4 style="text-align:center" id="reportTitle">Credit Purchase Report</h4>
