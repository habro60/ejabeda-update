...
<main class="app-content">
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i>Supplier Bill Paid Report</h1>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
    ...
    ?>
        <table id="submit">
            <form method="POST">
                <tr>
                    <td>Office: <select class="form-control grand" name="office_code">
                ...
                <td>Account/Supplier: <select class="form-control grand" name="gl_acc_code">
    ...
    <?php
        ...
        <table id="submit">
            ...
            ?>
                ...
                <h4 style="text-align:center" id="reportTitle">Supplier Bill Paid Report</h4>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if (empty($office_code)) {
                        ...
                        if (empty($gl_acc_code)) { 
                            $sql="select tran_details.tran_date,tran_details.batch_no, tran_details.gl_acc_code, tran_details.vaucher_type, tran_details.dr_amt_loc, tran_details.cr_amt_loc, invoice_detail.order_no,invoice_detail.gl_acc_code,invoice_detail.item_no,invoice_detail.item_qty,invoice_detail.unit_price_loc,invoice_detail.total_price_loc, invoice_detail.item_unit, invoice_detail.include_discount_rate, invoice_detail.include_discount_amt, invoice_detail.include_vat_rate, invoice_detail.include_vat_amt, invoice_detail.include_tax_rate, invoice_detail.include_tax_amt, gl_acc_code.acc_head as supp_name,item.id,item_name, code_master.description from tran_details,invoice_detail,item, gl_acc_code, code_master where tran_details.batch_no=invoice_detail.order_no and tran_details.gl_acc_code=invoice_detail.gl_acc_code and tran_details.tran_mode=invoice_detail.order_type and (invoice_detail.bill_status='CHQP' or invoice_detail.bill_status='CP') and (invoice_detail.order_type='CHQP' or invoice_detail.order_type='CP')  and gl_acc_code.acc_code=tran_details.gl_acc_code and invoice_detail.item_no=item.id AND (tran_details.tran_date BETWEEN '$startdate' AND '$enddate') and tran_details.office_code='$office_code'  and  code_master.hardcode='UCODE' and invoice_detail.item_unit=code_master.softcode order by tran_details.tran_date, tran_details.batch_no";

                        } else {
                            $gl_acc_code = $conn->escape_string($_POST['gl_acc_code']);
                            $sql="select tran_details.tran_date,tran_details.batch_no, tran_details.gl_acc_code, tran_details.vaucher_type, tran_details.dr_amt_loc, tran_details.cr_amt_loc, invoice_detail.order_no,invoice_detail.gl_acc_code,invoice_detail.item_no,invoice_detail.item_qty,invoice_detail.unit_price_loc,invoice_detail.total_price_loc, invoice_detail.item_unit, invoice_detail.include_discount_rate, invoice_detail.include_discount_amt, invoice_detail.include_vat_rate, invoice_detail.include_vat_amt, invoice_detail.include_tax_rate, invoice_detail.include_tax_amt, gl_acc_code.acc_head as supp_name,item.id,item_name, code_master.description from tran_details,invoice_detail,item, gl_acc_code, code_master where tran_details.batch_no=invoice_detail.order_no and tran_details.gl_acc_code=invoice_detail.gl_acc_code and tran_details.tran_mode=invoice_detail.order_type and (invoice_detail.bill_status='CHQP' or invoice_detail.bill_status='CP') and (invoice_detail.order_type='CHQP' or invoice_detail.order_type='CP') and gl_acc_code.acc_code=tran_details.gl_acc_code and invoice_detail.item_no=item.id AND (tran_details.tran_date BETWEEN '$startdate' AND '$enddate') and tran_details.office_code='$office_code'  and tran_detail.gl_acc_code= '$gl_acc_code' and code_master.hardcode='UCODE' and invoice_detail.item_unit=code_master.softcode order by tran_details.tran_date, tran_details.batch_no";
                        }
