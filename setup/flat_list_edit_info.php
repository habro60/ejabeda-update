...
if (isset($_POST['editSubmit'])) {
  ...
  $updateQuery = "UPDATE `flat_info` SET `id`='$id',`office_code`='$office_code',`flat_no`='$flat_no',`flat_area`='$flat_area',`side_of_flat`='$side_of_flat', `building`='$building', block_no='$block_no',`ss_modifier`='bisnu',`ss_modified_on`=now(),`ss_org_no`='$ss_org_no' where id='$id'";
  ...
  header('refresh:2;flat_list_info.php');
}
?>
<?php
if (isset($_GET['id'])) {
