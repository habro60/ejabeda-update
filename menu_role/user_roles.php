...
if (isset($_POST['SubBtn'])) {
  ...
  $insertQuery = "INSERT INTO `sm_role` (id, office_code, role_no,role_name,active_stat, ss_creator, ss_created_on,ss_org_no) VALUES (NULL, '$office_code','$role_no','$role_name','$active_stat', '$ss_creator', '$ss_created_on','$ss_org_no')";
  echo $insertQuery;
   exit;
