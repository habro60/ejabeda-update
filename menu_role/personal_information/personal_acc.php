        ...
        <table class="table table-hover table-bordered" id="memberTable">
          ...
          <tbody>
            ...
            while ($row = $query->fetch_assoc()) {
              ...
              ?>
              <td> <?php if ( $row['category_code']== 1){ echo "Cash A/c"; } elseif ( $row['category_code'] == 2){echo "Bank A/c";} elseif ( $row['category_code'] == 3){echo "Income A/c";} elseif ( $row['category_code'] == 4){echo "Expense A/c";}?> </td>
            </td>
