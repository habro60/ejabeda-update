...
<main class="app-content">
    <div class="app-title">
        <h1><i class="fa fa-dashboard"></i> Deposit & Expense Report </h1>
    </div>
    <!--  filter option -->
    <form method="POST">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div id="organizationAdd">
                ...
                <div id="reporttitle">
                     <h5 style="text-align:center" id="reportTitle">Deposit and Expenses Report</h5> 
                </div>
                <div id="AsOnDate">
                    ...
                    <div class="row">
                        <div class="cols6">
                            <table class="table table-hover table-striped" id="sampleTable">
                                ...
                                <tfoot>
                                    <?php
                                    $sql1="SELECT SUM(personal_ledger.dr_amt_loc - personal_ledger.cr_amt_loc) as opcash,gl_acc_code.acc_type  FROM personal_ledger, gl_acc_code where gl_acc_code.acc_code=personal_ledger.gl_acc_code and (personal_ledger.tran_date BETWEEN '$org_fin_year_st' AND '$startdate') and gl_acc_code.acc_type='1'";
                                    $query1 = mysqli_query($conn, $sql1);
                                    $cashrows = mysqli_fetch_assoc($query1);

                                    $sql2="SELECT SUM(personal_ledger.dr_amt_loc - personal_ledger.cr_amt_loc) as opbank,gl_acc_code.acc_type  FROM personal_ledger, gl_acc_code where gl_acc_code.acc_code=personal_ledger.gl_acc_code and (personal_ledger.tran_date BETWEEN '$org_fin_year_st' AND '$startdate') and gl_acc_code.acc_type='2'";
                        ...
                        <div class="cols6">
                            <div id="mySelector">
                                <table class="table table-hover table-striped" id="sampleTable">
                                    ...
                                    <tfoot>
                                        <?php
                                    $sq3="SELECT SUM(personal_ledger.dr_amt_loc - personal_ledger.cr_amt_loc) as closecash,personal_account.category_code  FROM personal_ledger, personal_account where personal_account.id=personal_ledger.gl_acc_code and (personal_ledger.tran_date BETWEEN '$org_fin_year_st' AND '$enddate') and personal_account.category_code='1'";
                                    $query = mysqli_query($conn, $sq3);
                                    $cashrows = mysqli_fetch_assoc($query);

                                    $sql4="SELECT SUM(personal_ledger.dr_amt_loc - personal_ledger.cr_amt_loc) as closebank,personal_account.category_code  FROM personal_ledger, personal_account where personal_account.id=personal_ledger.gl_acc_code and (personal_ledger.tran_date BETWEEN '$org_fin_year_st' AND '$enddate') and personal_account.category_code='2'";
