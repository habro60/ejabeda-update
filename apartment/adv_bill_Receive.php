...
// =================================== insert in to bill detail================
    ...
    $bill_upto_month = $_POST['bill_upto_month'];
     $mth=0;
...
//   $link_gl_acc_code =$_POST['link_gl_acc_code'];
  ...
  $insertBill = "INSERT INTO `tran_details` (`tran_no`,auto_tran_no,`office_code`,`year_code`,`batch_no`, `tran_date`,back_value_date, `gl_acc_code`,`tran_mode`,`vaucher_type`, `description`,dr_amt_loc, `cr_amt_loc`,`ss_creator`,`ss_creator_on`,`ss_org_no`) select null,'0',apart_owner_bill_detail.office_code, year(apart_owner_bill_detail.ss_created_on), '$batch_no','$bill_process_date1','9999-09-09', apart_owner_bill_detail.link_gl_acc_code, 'Bill','CR', concat(',', apart_owner_bill_detail.bill_charge_name,'  for  ', date_format(apart_owner_bill_detail.bill_date, '%M %Y'),'  to  ', '$bill_upto_month'), '0', sum(apart_owner_bill_detail.bill_amount), apart_owner_bill_detail.ss_creator, apart_owner_bill_detail.ss_created_on, apart_owner_bill_detail.ss_org_no from apart_owner_bill_detail where  apart_owner_bill_detail.batch_no ='$batch_no' group by apart_owner_bill_detail.bill_charge_code order by apart_owner_bill_detail.bill_charge_code";
//   echo $insertBill;
//   exit;
...
//   ==================================== insert in Owner Account  (Debit TRN)============================
  ...
  $insertOwner = "INSERT INTO `tran_details` (`tran_no`,auto_tran_no,`office_code`,`year_code`,`batch_no`, `tran_date`,back_value_date, `gl_acc_code`,`tran_mode`,`vaucher_type`, `description`, `dr_amt_loc`,cr_amt_loc,`ss_creator`,`ss_creator_on`,`ss_org_no`) select null,'0',apart_owner_bill_detail.office_code, year(apart_owner_bill_detail.ss_created_on), '$batch_no', '$bill_process_date1', '9999-09-09','$by_account', 'Bill','DR', concat(',', 'Bill and Charge','  for  ',date_format(apart_owner_bill_detail.bill_date,'%M %Y')), sum(apart_owner_bill_detail.bill_amount), '0', apart_owner_bill_detail.ss_creator, apart_owner_bill_detail.ss_created_on, apart_owner_bill_detail.ss_org_no from apart_owner_bill_detail where  apart_owner_bill_detail.batch_no='$batch_no' group by apart_owner_bill_detail.owner_gl_code order by apart_owner_bill_detail.owner_gl_code";
...
// ================================== close bill detail===================
    ...
    $particulardr = 'Advance Bill Received';
    $particularcr = 'Advance Bill Payment';
         ...
         <table>
           ...
           <div class="form-group row">
            ...
            <td><select name="by_account" class="form-control by_account" onchange="getFlatNo(this.value)" required>
                    ...
                    ?>
                    <?php
                            echo '<option value="' . $row_off['acc_code'] . '">' . $row_off['acc_head'] . ' - ' . $row_off['flat_no'] . '</option>';
                        }
                    }
                    ?>
                </select></td>
