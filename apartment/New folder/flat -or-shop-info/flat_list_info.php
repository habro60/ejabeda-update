...
if (isset($_POST['submit'])) {
  ...
  $insertData = "INSERT INTO flat_info (office_code, flat_no, flat_area,side_of_flat, building, `block_no`,flat_title,flat_status, status_date,ss_creator,ss_created_on,ss_modifier,ss_modified_on,ss_org_no) values ('$office_code','$flat_no','$flat_area','$side_of_flat','$building','$block_no','$flat_title','0',now(), '$ss_creator','$ss_created_on','$ss_creator','$ss_created_on','$ss_org_no')";
