                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <input type="text" name="flat_no[]" class="form-control" id="flat_no<?php echo $row['id']; ?>" value="<?php echo $row['flat_no']; ?>" style="width: 100%" readonly>
                        </td>
                        <td>
