...
// =============Fixed Bill============
  ...
  {
    $query2="INSERT INTO apart_owner_bill_detail (`id`,`office_code`,`owner_id`,`flat_no`, bill_for_month, bill_date,`bill_charge_code`,`bill_charge_name`,`pay_method`,`pay_curr`,prev_unit, curr_unit, net_unit,`bill_amount`,`owner_gl_code`,`link_gl_acc_code`,bill_process_date, batch_no, bill_paid_flag,per_unit_rate,vat_rate,fixed_rent) 

    SELECT null,monthly_bill_entry.office_code,monthly_bill_entry.owner_id,monthly_bill_entry.flat_no,  '$bill_for_month', '$bill_date', monthly_bill_entry.bill_charge_code,monthly_bill_entry.bill_charge_name, 'variable', monthly_bill_entry.pay_curr, monthly_bill_entry.prev_unit, monthly_bill_entry.curr_unit,monthly_bill_entry.net_unit,monthly_bill_entry.bill_amount,monthly_bill_entry.owner_gl_code,monthly_bill_entry.link_gl_acc_code, '$bill_process_date', '$lastRows', '0',monthly_bill_entry.per_unit_rate,monthly_bill_entry.vat_rate,monthly_bill_entry.fixed_rent  FROM  monthly_bill_entry where bill_for_month='$bill_for_month'";
     $conn->query($query2);
