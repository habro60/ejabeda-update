...
<main class="app-content">
    ...
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i> Chanda Due Report</h1>
        </div>
    </div>
    <!-- end page title -->
    <div class="row">
        ...
        <table id="submit">
            ...
            ?>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if (empty($member_id)) {
                            $sql="SELECT donner_fund_detail.member_id, donner_fund_detail.fund_type_desc, donner_fund_detail.num_of_paid, fund_member.full_name, donner_fund_detail.donner_paid_amt, (12 * (YEAR('2021-07-01') 
                            - YEAR(last_paid_date)) 
                     + (MONTH('2021-07-01') 
                         - MONTH(last_paid_date))) as due_month, donner_fund_detail.donner_pay_amt from donner_fund_detail,fund_member where donner_fund_detail.member_id=fund_member.member_id and allow_flag >'0' and donner_fund_detail.last_paid_date <= '$enddate' order by donner_fund_detail.member_id"; 
                            ...
                            - YEAR(last_paid_date)) 
                     + (MONTH('2021-07-01') 
                         - MONTH(last_paid_date)) as due_month, donner_fund_detail.donner_pay_amt from donner_fund_detail,fund_member where donner_fund_detail.member_id=fund_member.member_id and allow_flag >'0' and donner_fund_detail.member_id='$member_id' and donner_fund_detail.last_paid_date <= '$enddate'";
                ...
                <div id="mySelector">
                    ...
                    <td style="text-align: center"><?php if ($rows['member_id'] != $mem_id) {
                        ...
                        <td style="background-color:white; text-align: right"><?php $due_amt = ($rows['donner_pay_amt'] * $rows['due_month']); $tot_due_amt = $tot_due_amt + $due_amt; echo $due_amt;  ?></td>                                                                        
