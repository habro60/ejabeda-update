...
<main class="app-content">
    ...
    ?>
        <table id="submit">
            <form method="POST">
                <tr>
                     <td> Notice: <input type="text" name="text_message" id="" class="form-control">
            ...
            ?>
                ...
                <h4 style="text-align:center" id="reportTitle">Notice</h4>
                <div class="pull-right">
                <a id='SMS' title="Send SMS" class="btn btn-success" href="SMS_notice.php"></i>SMS Notice</a>
                </div>
                <br><br>
