                ...
                $tot_dr_amt=0.00;
                 ...
                 if (isset($_POST['submit'])) {
                  ...
                  if (isset($_POST['induvidul'])) {
                    ...
                    $sql="select tran_details.tran_date,tran_details.batch_no, tran_details.gl_acc_code, tran_details.vaucher_type, tran_details.dr_amt_loc, tran_details.cr_amt_loc, invoice_detail.order_no,supp_info.gl_acc_code,supp_info.supp_name,invoice_detail.gl_acc_code,invoice_detail.item_no,invoice_detail.item_qty,invoice_detail.unit_price_loc,invoice_detail.total_price_loc, invoice_detail.item_unit,invoice_detail.include_discount_rate, invoice_detail.include_discount_amt, invoice_detail.include_vat_rate, invoice_detail.include_vat_amt, invoice_detail.include_tax_rate, invoice_detail.include_tax_amt, item.id,item_name from tran_details,supp_info,invoice_detail,item where supp_info.id='$supp_id' and tran_details.batch_no=invoice_detail.order_no and tran_details.gl_acc_code=supp_info.gl_acc_code and tran_details.tran_mode=invoice_detail.order_type and tran_details.tran_mode !='CV' and invoice_detail.item_no=item.id order by tran_details.batch_no";

                  }
                 } else {   
                     
                    $sql="select tran_details.tran_date,tran_details.batch_no, tran_details.gl_acc_code, tran_details.vaucher_type, tran_details.dr_amt_loc, tran_details.cr_amt_loc, invoice_detail.order_no,supp_info.gl_acc_code,supp_info.supp_name,invoice_detail.gl_acc_code,invoice_detail.item_no,invoice_detail.item_qty,invoice_detail.unit_price_loc,invoice_detail.total_price_loc, invoice_detail.item_unit, invoice_detail.include_discount_rate, invoice_detail.include_discount_amt, invoice_detail.include_vat_rate, invoice_detail.include_vat_amt, invoice_detail.include_tax_rate, invoice_detail.include_tax_amt, item.id,item_name from tran_details,supp_info,invoice_detail,item where tran_details.gl_acc_code=supp_info.gl_acc_code and tran_details.batch_no=invoice_detail.order_no and tran_details.gl_acc_code=invoice_detail.gl_acc_code and tran_details.tran_mode=invoice_detail.order_type and tran_details.tran_mode !='CP' and invoice_detail.item_no=item.id order by tran_details.batch_no";
                 }
