...
if (empty($owner_id)) {
    ...
    $sql2 =  "SELECT  supp_info.id, supp_info.supp_name, supp_info.gl_acc_code, invoice_detail.gl_acc_code FROM  supp_info, invoice_detail where supp_info.id = $supp_id ORDER BY supp_info.gl_acc_code, invoice_detail.order_date";
}
