...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i>Purchase Detail (cash, CHQ &  Others)</h1>
        </div>
    </div>
    <!-- search option -->
    ...
    ?>
        <table id="submit">
            <form method="POST">
                <tr>
                    <td>Purchase A/C : <select class="form-control grand" name="gl_acc_code">
                            <option value="">--- Select Account ---</option>
                            <?php
                            $selectQuery = "SELECT * FROM `gl_acc_code` where  (acc_type=1 or acc_type='2' or subsidiary_group_code='300') and postable_acc= 'Y' ORDER by acc_code";
    ...
    <div>
     ...
     <div>
        <h4 style="text-align:center">Purchase Details </h4>
    </div>
    <!-- report header end -->
    <!-- search option -->
