...
if (isset($_POST['SubBtn'])) {
  ...
  $insertQuery = "INSERT INTO `sm_hr_emp` (`emp_no`,`emp_id`,`office_code`,`desig_code`,`join_date`,`f_name`,`l_name`,`father_name`,`mother_name`,`husband_name`,`gender`,`dob`,`blood_group`,`religion`,`marital_status`,`email_personal`,`email_official`,`phone_home`,`phone_mobile`,`phone_office`,`nationality`,`village`,`division`,`district`,`upazila`,`p_office`,`p_code`,`p_village`,`p_division`,`p_district`,`p_upazila`,`p_p_office`,`p_p_code`,`nid`,`passport_no`,`driving_lc_no`,`tin_no`,`next_incr_date`,`employee_image`,`ss_creator`,`ss_created_on`,`ss_org_no`) VALUES (NULL,'$emp_id','$office_code','$desig_code','$join_date','$f_name','$l_name','$father_name','$mother_name','$husband_name','$gender','$dob','$blood_group','$religion','$marital_status','$email_personal','$email_official','$phone_home','$phone_mobile','$phone_office','$nationality','$village','$division','$district','$upazila','$p_office','','$p_village','$p_division','$p_district','$p_upazila','$p_p_office','','$nid','$passport_no','$driving_lc_no','$tin_no','$next_incr_date','$userPic','$ss_creator',now(),'$ss_org_no')";
...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-dashboard"></i> Add Employee </h1>
    </div>
    ...
    <div class="col-md-10 mx-auto">
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="form-row form-group">
          <label class="col-sm-2 col-form-label">Office <span style="color:red">*</span></label>
          ...
          <label class="col-form-label">:</label>
          <div class="col">
            <input type="text" name="emp_id" id="userid" class="form-control" onBlur="checkUserAvailability()" placeholder="User ID" required>
            <tr>
        ...
        <div class="form-row form-group">
          ...
          <label class="col-form-label">:</label>
          <div class="col">
            <input type="email" name="email_personal" class="form-control" id="emailid" onBlur="checkemailAvailability()" placeholder="admin@domain.com">
            <tr>
              <th width="24%" scope="row"></th>
        ...
        <div class="form-row form-group">
          ...
          <label class="col-form-label">:</label>
          <div class="col">
            <input type="number" name="nid" class="form-control" placeholder="Nationa ID No" >
          </div>
