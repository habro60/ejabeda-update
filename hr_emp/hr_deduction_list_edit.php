...
if (isset($_POST['editSubmit'])) {
    ...
    $updateQuery = "UPDATE `hr_deduction_setup` SET `office_code`='$office_code',`year_of_scale`='$year_of_scale',
  `desig_code`='$desig_code', `deduction_code`='$deduction_code',
   `deduction_desc`='$deduction_desc', `deduction_type`='$deduction_type', `deduction_amt`='$deduction_amt',
...
if (isset($_GET['id'])) {
    $id = intval($_GET['id']);
    $selectQueryEdit = "SELECT * FROM hr_deduction_setup where id='$id'";
...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-dashboard"></i> Edit deduction Information </h1>
        </div>
                ...
                <div id="">
                    <div style="padding:5px">
                        ...
                        <form action="" method="post">
                            ...
                            <!-- deduction Code -->
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Deduction Code</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="" name="deduction_code" value="<?php echo $rows['deduction_code']; ?>">
                                </div>
                            </div>

                            <!-- deduction Description -->
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Deduction Description</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="" name="deduction_desc" value="<?php echo $rows['deduction_desc']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                   <input type="radio" id="amntslt" name="deduction_type" value="fixed"<?php echo ($rows['deduction_type']=='fixed')?'checked':'' ?> >
                                        <label for="amount"> Fixed</label><br>

                                        <input type="radio" id="amntperc" name="deduction_type" value="percentage"<?php echo ($rows['deduction_type']=='percentage')?'checked':'' ?>  >
                            ...
                            <!-- deduction Amount -->
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Deduction Amount</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" id="" name="deduction_amt" value="<?php echo $rows['deduction_amt']; ?>">
                                </div>
                            </div>
