...
if (isset($_POST['submit'])) {
    ...
    $insertData = "INSERT INTO hr_allowance_setup (office_code, year_of_scale,desig_code, 
    ...
    '$desig_code','$allowance_code', '$allowance_desc','$allowance_type','$allowance_amt',
                            ...
                            <input type="text" class="form-control" id="" name="office_code">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <input type="radio" id="amntslt" name="allowance_type" value="fixed" onclick="EnableDisableTextBox(this)">
                                                        <label for="amount"> Fixed</label><br>

                                                        <input type="radio" id="amntperc" name="allowance_type" value="percentage" onclick="EnableDisableTextBox(this)">
            ...
            <div class="tile-body">
                ...
                <table class="table table-hover table-bordered" id="memberTable">
                    ...
                    <tbody>
                        <?php
                        $no = 0;
                        $sql = "select hr_allowance_setup.*,hr_desig.desig_desc from hr_desig RIGHT JOIN hr_allowance_setup
                        ON hr_desig.desig_code=hr_allowance_setup.desig_code";
                        //use for MySQLi-OOP
