...
if (isset($_POST['subBtn'])) {
  ...
  $insertQuery = "INSERT INTO `office_info` (`id`, `office_code`, `office_name`,`rep_glcode`,`category_code`,`level_no`,`office_type`,`parent_code`,`ss_creator`,`ss_creator_on`,`ss_org_no`) VALUES (NULL,'$office_code','$office_code','$office_name','$rep_glcode','$category_code','$level_no','$office_type','$parent_code',$ss_creator',now(),'$ss_org_no')";
    ...
    <div class="col-md-12">
      <div>
        ...
        <div id="demo" class="collapse">
          <div style="padding:5px;">
            ...
            <form action="" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="office_name" name="office_name" onkeyup="office_check_availability()" required>
                  <tr>
          ...
          <!-- lavel  -->
          <input type="number" name="level_no" class="form-control" value="1" hidden>
